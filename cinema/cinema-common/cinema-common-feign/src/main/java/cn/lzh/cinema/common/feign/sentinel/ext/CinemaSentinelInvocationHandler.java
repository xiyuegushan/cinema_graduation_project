 ...
 */
@Slf4j
public class CinemaSentinelInvocationHandler implements InvocationHandler {
	...
	CinemaSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			CinemaSentinelInvocationHandler other = (CinemaSentinelInvocationHandler) obj;
