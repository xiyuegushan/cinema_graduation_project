...
import cn.lzh.cinema.admin.api.feign.RemoteUserService;
...
public class CinemaAppUserDetailsServiceImpl implements CinemaUserDetailsService {
	...
	public UserDetails loadUserByUsername(String phone) {
		...
		if (cache != null && cache.get(phone) != null) {
			return (CinemaUser) cache.get(phone).get();
		}
	 ...
	 */
	@Override
	public UserDetails loadUserByUser(CinemaUser cinemaUser) {
		return this.loadUserByUsername(cinemaUser.getPhone());
	}
