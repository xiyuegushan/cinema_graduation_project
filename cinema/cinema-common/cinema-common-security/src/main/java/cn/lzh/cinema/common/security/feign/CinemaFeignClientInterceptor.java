...
package cn.lzh.cinema.common.security.feign;
 ...
 */
@Slf4j
public class CinemaFeignClientInterceptor extends OAuth2FeignRequestInterceptor {
	 ...
	 */
	public CinemaFeignClientInterceptor(OAuth2ClientContext oAuth2ClientContext, OAuth2ProtectedResourceDetails resource,
