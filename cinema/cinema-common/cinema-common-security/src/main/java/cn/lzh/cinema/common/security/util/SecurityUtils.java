...
package cn.lzh.cinema.common.security.util;
...
public class SecurityUtils {
	 ...
	 * 获取用户
	 */
	public CinemaUser getUser(Authentication authentication) {
		Object principal = authentication.getPrincipal();
		if (principal instanceof CinemaUser) {
			return (CinemaUser) principal;
		}
		return null;
	}
