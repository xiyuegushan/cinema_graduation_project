...
import cn.lzh.cinema.common.security.exception.*;
 ...
 */
@Slf4j
public class CinemaWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
	...
	private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
		...
		return new ResponseEntity<>(new CinemaAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,
