 ...
 */
@Slf4j
public class CinemaSecurityBeanDefinitionRegistrar implements ImportBeanDefinitionRegistrar {
	...
	public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
		...
		beanDefinition.setBeanClass(CinemaResourceServerConfigurerAdapter.class);
