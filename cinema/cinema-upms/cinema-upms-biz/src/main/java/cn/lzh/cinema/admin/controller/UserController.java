...
package cn.lzh.cinema.admin.controller;
...
import cn.lzh.cinema.admin.api.vo.UserInfoVO;
...
import cn.lzh.cinema.common.security.annotation.Inner;
...
public class UserController {
	...
	public R<Boolean> register(@RequestBody UserDTO userDto) {
		if (userService.register(userDto)) {
			return R.ok(Boolean.TRUE, "注册成功");
		} else {
			return R.failed(Boolean.FALSE, "注册失败");
		}
	}
