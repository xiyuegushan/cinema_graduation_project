...
package cn.lzh.cinema.admin.service.impl;
...
import cn.lzh.cinema.admin.api.dto.UserDTO;
import cn.lzh.cinema.admin.api.dto.UserInfo;
import cn.lzh.cinema.admin.api.entity.*;
import cn.lzh.cinema.admin.api.vo.UserExcelVO;
import cn.lzh.cinema.admin.api.vo.UserVO;
import cn.lzh.cinema.admin.mapper.SysDeptMapper;
import cn.lzh.cinema.admin.mapper.SysRoleMapper;
import cn.lzh.cinema.admin.mapper.SysUserMapper;
import cn.lzh.cinema.admin.mapper.SysUserRoleMapper;
import cn.lzh.cinema.admin.service.SysMenuService;
import cn.lzh.cinema.admin.service.SysUserService;
import cn.lzh.cinema.common.core.constant.CacheConstants;
import cn.lzh.cinema.common.core.constant.CommonConstants;
import cn.lzh.cinema.common.core.constant.enums.MenuTypeEnum;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
	...
	public Boolean register(UserDTO userDto) {
		...
		SysUser unique = getOne(new QueryWrapper<>(condition));
		if (ObjectUtil.isNotNull(unique)) {
			return Boolean.FALSE;
		}
		SysUser sysUser = new SysUser();
		BeanUtils.copyProperties(userDto, sysUser);
		// 设置默认部门为用户部门
		sysUser.setDeptId(1512741238321750017L);
		...
		roleIdList.add(1510133309030551554L);
