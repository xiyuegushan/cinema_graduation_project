...
package cn.lzh.cinema.codegen;

import cn.lzh.cinema.common.datasource.annotation.EnableDynamicDataSource;
...
public class CinemaCodeGenApplication {

	public static void main(String[] args) {
		SpringApplication.run(CinemaCodeGenApplication.class, args);
	}
